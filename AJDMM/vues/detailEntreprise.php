        ...
        <div class="row">
            ...
            <div class="column middle">
                 ...
                 <div class="stage">
                    ...
                    {?>
                    <p><span>Nom:</span><span class="gros"> <?php echo $rangee["nom_entreprise"] ; ?></span></p>
                    <p><span>Adresse:</span><?php echo $rangee["adresse"] .' '. $rangee["rue"].', '. $rangee["Ville"]  ; ?></p>
                    <p><span>Spécialité:</span> <?php echo $rangee["specialite"] ; ?></p>
                    <p><span>Description:</span> <?php echo $rangee["description"] ; ?></p>  
                    <p><span>Nb employés:</span> <?php echo $rangee["nombre_employe"] ; ?></p>  
                    <p><span>Personne responsable:</span> <?php echo $rangee["prenom"] .' '. $rangee["nom"] ; ?></p>
                    <p ><span>Courriel:</span> <?php echo $rangee["courriel"] ; ?></p>
                    <p ><span>Téléphone:</span> <?php echo $rangee["telephone"] ; ?></p><?php
                    }?>
