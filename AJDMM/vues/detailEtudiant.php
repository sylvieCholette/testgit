        ...
        <div class="row">
            ...
            <div class="column middle">
                ...
                <div class="stage">
                    ...
                    {?>
                    <p><span>Nom:</span><span class="gros"> <?php echo $rangee["nom"] ; ?></span></p>
                    <p><span>Prénom:</span><span  class="gros"> <?php echo $rangee["prenom"] ; ?></span></p>
                    <p><span>Spécialité:</span> <?php echo $rangee["specialite"] ; ?></p>
                    <p><span>Résumé:</span> <?php echo $rangee["resume"] ; ?></p> 
                    <p><span>Statut:</span> <?php echo $rangee["statut"] ; ?></p> 
                    <p><span>Adresse:</span> <?php echo $rangee["adresse"] .' '. $rangee["rue"] ; ?></p>
                    <p><span>Ville:</span> <?php echo $rangee["Ville"] ; ?></p>
                    <p><span>Courriel:</span> <?php echo $rangee["courriel"] ; ?></p>
                    <div><p id="tel"><span class="anim">Téléphone:<?php echo $rangee["telephone"] ; ?></span> </p></div><br>
                    <?php echo"<a class='modif' href='index.php?action=modifEtudiant&idEtudiant=" . $rangee["idEtudiant"] . "'>Modifier mon profil.</a>"?>
                    <?php
                    }?>
