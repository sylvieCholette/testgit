    ...
    <div class="header">
        <div class="login">
            <div id="login">
                ...
                <a href=""><img id="connect" class="haut" src="images/connection.png" alt="connection"></a>
        ...
        <div class="row">
            ...
            <div class="column middle">
                <div class="caroussel">
                    ...
                    <!--                debut code internet  Caroussel-->
                    <!--                    Source : /*source : https://codepen.io/trungk18/pen/EydyoL */-->
                    <div class="wrapper">
                            ...
                            <div class=inner>
                                <article>
                                    <div class="info top-left">
                                        <h3>Nos finissants</h3>
                                    </div>
                                    <img src="images/finissants.jpg" />
                                </article>
                    ...
                    <!-- fin code internet caroussel-->
                </div>

                <div class="mission">
                    <h2>Notre Mission</h2>
                    <p>Ensemble, avec nos clients et nos partenaires, nous créons un avenir durable pour le web d'ici et d'ailleurs.</p>
                    <p>Combiner les connaissances, l’expertise opérationnelle, la technologie et les ressources de nos partenaires afin d’aider nos étudiants à se trouvé des emplois des plus enrichissants.</p>
                </div>
            </div>
            ...
            <div class="column left">
                <h2>Stages</h2>
                <h3>Caméléon Média</h3>
                <p>Caméléon Média place le développement personnel et le développement professionnel au cœur de ses valeurs. Notre mission se définit en deux mots : vulgarisation et transparence. Nous profitons d'un environnement de travail agréable loin des embouteillages de la grande ville.<br>

                    Nous sommes à la recherche de personnes qui ont une attitude positive et qui sont prêtes à relever des défis. Nous cherchons des personnes intègres et auto-motivées.</p>
                <h3>CIDMA</h3>
                <p>La division web de l’agence CIDMA est à la recherche d’un(e) stagiaire en marketing motivé(e) et dynamique pour se joindre à notre équipe! Tu es autonome, responsable, ordonné(e) et débordant(e) de créativité, dépose ta candidature immédiatement.</p>
                <div class="bouton">
                    <button class="button" type="submit" value="Submit">Accéder aux stages</button>
                </div>
            </div>
