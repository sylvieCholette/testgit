    ...
    <nav id="topnav" class="menuBurger" role="navigation">
        <div id="menuContainer">
            ...
            <ul id="menu">
                ...
                <li class="active"><a href="index.php?action=listeProf"  title="enseignant">Enseignants</a> </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="column middle">
                ...
                <div class="stage">
                    <h2>La liste des enseignants des jeunes développeurs du collège Maisonneuve</h2>
                    <button onclick="topFunction()" id="myBtn" title="Go to top">Haut</button>
                    <table class="table" >
<!--            <thead><tr><th class="event-nom">Nom</th><th class="event-prenom">Prénom</th><th class="event-specialite">Spécialité</th><th class="event-courriel">Courriel</th><th class="event-profil">Profil</th></tr></thead>-->
                    <thead><tr><th>Nom</th><th>Prénom</th><th>Spécialité</th><th>Courriel</th><th>Profil</th></tr></thead>       
                   ...
                   <tbody>
                    ...
                    {?>
                    <tr>
                    <td  data-label='Nom'><?php echo $rangee["nom"] ; ?></td>
                    <td data-label='Prénom'><?php echo $rangee["prenom"] ; ?></td>
                    <td data-label='Spécialité'><?php echo $rangee["specialite"] ; ?></td>
                    <td data-label='Courriel'><?php echo $rangee["courriel"] ; ?></td>
                    <td data-label='Profil'><?php echo "<a href='index.php?action=profil_prof&idProf=". $rangee["idProf"]."'>Profil complet</a>" ; ?></td>
                    </tr><?php
                    }?>
                   </tbody>
                    </table>
